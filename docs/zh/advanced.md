...
GitHub 仓库的 [examples](https://github.com/bunkerity/bunkerweb/tree/v1.6.8-rc2/examples) 文件夹中提供了许多真实世界的用例示例。

我们还提供了许多样板文件，例如用于各种集成和数据库类型的 YAML 文件。这些都可以在 [misc/integrations](https://github.com/bunkerity/bunkerweb/tree/v1.6.8-rc2/misc/integrations) 文件夹中找到。
